...
// page OUTILS passage au clic du like insta en rose

document
  .getElementById("likeInstaColorO1")
...
document
  .getElementById("likeInstaColorO2")
  .addEventListener("click", function () {
    if (
      this.getAttribute("src") ==
      "assets/img/icones/icones insta/like-instagram.png"
...
document
  .getElementById("likeInstaColorO3")
  .addEventListener("click", function () {
    if (
      this.getAttribute("src") ==
      "assets/img/icones/icones insta/like-instagram.png"
...
document
  .getElementById("likeInstaColorO4")
  .addEventListener("click", function () {
    if (
      this.getAttribute("src") ==
      "assets/img/icones/icones insta/like-instagram.png"
