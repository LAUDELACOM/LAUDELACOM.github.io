...
// page competences changement couleur like insta

document
  .getElementById("likeInstaColorC1")
...
document
  .getElementById("likeInstaColorC2")
  .addEventListener("click", function () {
    if (
      this.getAttribute("src") ==
      "assets/img/icones/icones insta/like-instagram.png"
...
document
  .getElementById("likeInstaColorC3")
  .addEventListener("click", function () {
    if (
      this.getAttribute("src") ==
      "assets/img/icones/icones insta/like-instagram.png"
...
document
  .getElementById("likeInstaColorC4")
  .addEventListener("click", function () {
    if (
      this.getAttribute("src") ==
      "assets/img/icones/icones insta/like-instagram.png"
